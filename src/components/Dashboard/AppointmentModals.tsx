                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
                        ...
                        <div>
                            ...
                            <p style={{ fontSize: '12px', color: 'var(--muted)' }}>
                                ID: {appointment.id ? appointment.id.slice(0, 8) : "N/A"}
                            </p>
                        </div>
                    </div>
        ...
        <Modal isOpen={isOpen} onClose={onClose} title="Edit Appointment">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="modal-footer">
                    ...
                    <button type="button" onClick={onClose} className="btn" style={{ padding: '10px 24px', border: '1px solid var(--border)', backgroundColor: 'transparent' }}>
                        Cancel
                    </button>
...
/* Remaining modals unchanged below */
